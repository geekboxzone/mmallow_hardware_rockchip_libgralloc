...
#ifdef USE_RK_ION
	//ALOGD("[%d,%d,%d], usage=%x,ion_heap_type=%d", m->ion_client, size, ion_flags, usage,ion_heap_type);   
	//ALOGD("heap_mask=%x,ION_HEAP=%x",heap_mask, ION_HEAP(ION_CMA_HEAP_ID));
